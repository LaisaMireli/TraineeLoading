...
const Services = () => {
    return (
        ...
        <div className="text-center">
            ...
            <span className="text-black text-4xl ml-1 font-montserrat font-medium">DOS NOSSOS</span>
            </div>
            <div className="text-6xl text-MediumPurple font-montserrat font-extrabold my-4">Serviços</div>
