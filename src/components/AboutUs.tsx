...
const AboutUs = () => {
    return (
        ...
        <div className="flex items-center justify-center flex-col">
            <h2 className="text-2xl md:text-4xl font-montserrat font-medium text-black"><span className="text-MediumPurple  font-montserrat text-4xl">+</span>SOBRE NOSSOS</h2>
            <p className="text-4xl font-montserrat text-MediumPurple font-extrabold mt-4 leading-none">CLIENTES E <br /> PARCEIROS</p><p className="md:text-xl font-montserrat mt-4">Já pensou em ter sua logo aqui?</p>
