    ...
    return (
        <div className="bg-white flex flex-col lg:flex-row items-center justify-center p-8">
            ...
            <div className="flex items-center">
                ...
                <img src="/assets/moço.png" alt="Homem em pé com a perna cruzada em '4'" className="w-16 h-48 lg:w-auto lg:h-auto mt-4 lg:mt-0" />
            </div>
            {/* Parte Direita */}
            <div className="w-full grid justify-items-stretch  lg:w-1/2 lg:pl-8 text-center justify-center lg:text-left mt-6 lg:mt-0 order-2 lg:order-1">
                <div className="flex flex-col items-start">
                    <div className="flex items-center mb-8">
                        <img src="/assets/bola1.png" alt="bola com o número 1" className="w-10 h-10 lg:w-9 lg:h-9" />
                        <p className="ml-4 text-xl font-montserrat lg:text-base font-medium">Nos mande uma mensagem no whatsapp</p>
                    </div>

                    <div className="flex items-center mb-8">
                        <img src="/assets/bola2.png" alt="bola com o número 2" className="w-10 h-10 lg:w-9 lg:h-9 md:w-10 sm:w-10" />
                    ...
                    <div className="flex items-center mb-8">
                        <img src="/assets/bola3.png" alt="bola com o número 3" className="w-10 h-10 lg:w-9 lg:h-9" />
                        <p className="ml-4 text-xl font-montserrat lg:text-base font-medium">Fazemos uma proposta de serviço</p>
                    </div>

                    <div className="flex items-center mb-8">
                        <img src="/assets/bola4.png" alt="bola com o número 4" className="w-10 h-10 lg:w-9 lg:h-9" />
