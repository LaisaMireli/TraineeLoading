...
const AboutUs = () => {
    return (
        ...
        <div className="flex items-center justify-center flex-col"><h2 className="text-2xl md:text-4xl font-medium text-black"><span className="text-MediumPurple text-4xl">+</span>SOBRE NOSSOS</h2><p className="text-6xl text-MediumPurple font-extrabold mt-4 leading-none">CLIENTES E <br /> PARCEIROS</p><p className="md:text-xl mt-4">Já pensou em ter sua logo aqui?</p>
